...
namespace CefGlue
{
    ...
    public abstract unsafe partial class CefStorageVisitor 
    {
#if DIAGNOSTICS
        internal static int ObjectCt;
#endif

        private static ObjectTable<CefStorageVisitor> pointers = new ObjectTable<CefStorageVisitor>();
        ...
        private cef_base_t.release_delegate bs_release;
        private cef_base_t.get_refct_delegate bs_get_refct;
        private cef_storage_visitor_t.visit_delegate bs_visit;
        ...
        protected CefStorageVisitor()
        {
...
#if DIAGNOSTICS
            Cef.Logger.Trace(LogTarget.CefStorageVisitor, this.ptr, LogOperation.Create);
#endif
            ...
            this.bs_visit = new cef_storage_visitor_t.visit_delegate(this.visit);
            this.ptr->visit = Marshal.GetFunctionPointerForDelegate(this.bs_visit);
        ...
        {
#if DIAGNOSTICS
            Cef.Logger.Trace(LogTarget.CefStorageVisitor, this.ptr, "~CefStorageVisitor");
#endif
            Dispose(false);
        }
        ...
        {
#if DIAGNOSTICS
            Cef.Logger.Trace(LogTarget.CefStorageVisitor, this.ptr, LogOperation.Dispose, "Disposing=[{0}]", disposing);
#endif
            ...
            if (this.ptr != null)
            {
                ...
                Interlocked.Decrement(ref ObjectCt);
#endif
                cef_storage_visitor_t.Free(this.ptr);
                this.ptr = null;
            }
        ...
        internal cef_storage_visitor_t* NativePointer
        {
            get { return this.ptr; }
        }

        internal cef_storage_visitor_t* GetNativePointerAndAddRef()
        {
            AddRef();
            return this.ptr;
        }
        ...
        private static void ThrowObjectDisposedException()
        {
            throw new ObjectDisposedException("CefStorageVisitor");
        }
